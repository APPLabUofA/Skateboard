...
exp = 'Skateboard';
subs = {'100' '101' '102'};
%subs = {'102'}; %to test on just one sub 
...
pick_trials = 195; %pick per resample
electrode = 7;% pz
...
for i_sub = 1:nsubs 
    ...
    for i_cond = 1:nconds
        ...
        EEG = pop_loadset('filename',[Filename '_Corrected_Standard.set'],'filepath',[Pathname '\segmentsFFT\']);
